...
class BannersControllerTest < ActionController::TestCase
  ...
  test "should create banner" do
    assert_difference('Banner.count') do
      post :create, banner: { banner_url: @banner.banner_url, image_url: @banner.image_url, position: @banner.position }
    end
  ...
  test "should update banner" do
    patch :update, id: @banner, banner: { banner_url: @banner.banner_url, image_url: @banner.image_url, position: @banner.position }
    assert_redirected_to banner_path(assigns(:banner))
  end
